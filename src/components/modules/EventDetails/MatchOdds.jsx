    ...
    <Fragment>
      {data?.length > 0 &&
        data?.map((game) => {
          ...
          return (
            <div key={game?.id} className="relative border border-gray-300">
              <div className="flex justify-between items-center bg-secondary text-white px-2 py-2">
                <div className="flex items-center justify-start gap-1">
                  <svg
                    ...
                    strokeWidth={0}
                    viewBox="0 0 576 512"
                    className="cursor-pointer min-h-[22px] max-h-[22px]"
                    height="1em"
                    width="1em"
    ...
    cursor-pointer ${
      teamProfitForGame?.profit > 0
        ...
        : "bg-bg_color_clearBtn"
              ...
              <div className="flex flex-col px bg-white border border-solid border-neutral-200 max-md:max-w-full">
                <table className="w-full text-[14px] font-medium text-stone-900">
                  <thead>
                    <tr className=" py-2 text-[14px] font-medium whitespace-nowrap h-[32px] bg-white  ">
                      <th className="w-[70%] text-left pl-3 text-teal">
